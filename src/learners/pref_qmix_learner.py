...
class Pref_QLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        # seperate mixer and agent network, for both differ and unsup reset
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        q_grad_norm = th.nn.utils.clip_grad_norm_(self.agent_params, self.args.grad_norm_clip)
    ...
    def save_models(self, path):
        ...
        th.save(self.agent_optimizer.state_dict(), "{}/q_opt.th".format(path))
    ...
    def load_models(self, path):
        ...
        self.agent_optimizer.load_state_dict(th.load("{}/q_opt.th".format(path), map_location=lambda storage, loc: storage))
