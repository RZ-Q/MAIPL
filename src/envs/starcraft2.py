...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        reward_indi_only_positive=False,
        ...
        self.add_center_xy = True  # same as mappo setting
        ...
        self.n_obs_height = 9
        self.state_agent_id = True

        # Rewards args
        self.reward_sparse = reward_sparse
        self.reward_only_positive = reward_only_positive
        self.reward_indi_only_positive = reward_indi_only_positive
    ...
    def step(self, actions):
        ...
        terminated = False
        reward, agents_dense_rewards = self.reward_battle(actions_int)
    ...
    def reward_battle(self, actions: list):
        ...
        # calculate enenmy being attacked times
        enemy_attcked_times = [0 for _ in range(self.n_enemies)]
        for a in actions:
            if a >= self.n_actions_no_attack:
                enemy_attcked_times[a - self.n_actions_no_attack] += 1
    ...
    def get_state_agents(self):
        """Returns all agent specific state in a list."""
    ...
    def get_agent_state_size(self):
        """Returns the size of the agent specific state."""
    ...
    def get_env_info(self):
        ...
        env_info["agent_state_shape"] = self.get_agent_state_size()
        return env_info
